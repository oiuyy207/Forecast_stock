...
def attention_enc_dec(window_size,d_model,num_heads,name='attention_enc2dec'):
    ...
    #concat_outputs = tf.keras.layers.Dense(units=d_model, name="summary_concatenate_output")(concat_outputs)
...
def multi_enc_transformer(window_size, forecast_range, P, N, I, num_layers, dff,
    ...
    #    'mask': None
    #})
    #enc_outputs = tf.keras.layers.Dense(units=d_model, name="encoders_attention")(concat_outputs)
