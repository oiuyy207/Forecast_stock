...
#config
path, path_asset, _ = make_dataset_for_M6(start_date='2012-01-01',end_date="2022-03-01",path = "./stock_220228")
#path = './stock_220228'
#path_asset = './stock_220228/asset'

INDEX_DATA = make_index_data(start_date='2012-01-01',end_date="2022-03-01")
...
model_save_path = "./model_save/model_220228_ABBV"
...
def one_model_iter(Window_size,Window_size_CC):
    all_stock = StockData_target_asset(path_asset,
                                       "ABBV",
                                       INDEX_DATA,
                                       Window_size,
                                       Window_size_CC,
    ...
    _,_ = scaler_info_csv(all_stock.scaler, all_stock.indexScaler, Window_size, all_stock.include_asset, all_stock.include_index,model_save_path)
    ...
    optimizer=tf.keras.optimizers.Adam(adam_lr_start)
    evalution_costplt=[]
    
    linear_decrease_lr_sp = int(3/4*epochs)
    ...
    print(f'{"batch nums":>40} : {all_stock.batchNum}')
    print("-"*70)
