...
#config
path, path_asset, _ = make_dataset_for_M6(start_date='2012-01-01',end_date="2021-12-31",path = "./stock_211231")
#path = './stock_20h'
#path_asset = './stock_20h/asset'

INDEX_DATA = make_index_data(start_date='2012-01-01',end_date="2021-12-31")
...
model_save_path = "./model_save/model_211231"
